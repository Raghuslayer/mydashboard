...
import {
    ...
    faExclamationTriangle, faCheckCircle, faBolt, faPen
} from '@fortawesome/free-solid-svg-icons';

export default function DailySummary({ entry }) {
    if (!entry) return null;

    const { analysis, responses, date, text, type } = entry;

    // Safe destructure — analysis may be undefined for manual entries
    const {
        overallMood = 0,
        feeling = 'Logged',
        emoji = '📝',
    ...
    // Manual-only entry (no check-in data)
    if (type === 'manual' && !analysis) {
        return (
            <motion.div
            ...
            >
                ...
                <div className="glass-panel p-8 text-center relative overflow-hidden">
                    <div className="absolute inset-0 opacity-10" style={{ backgroundColor: '#ff5e00' }} />
                    <div className="relative z-10">
                        <div className="text-8xl mb-4">📝</div>
                        <h2 className="text-3xl font-bold mb-2 text-fire-orange">Manual Entry</h2>
